...
export class GanaCasinoProvider extends ICasinoProvider {
  ...
  async login() {
    try {
      ...
      // Implementar el proceso de login específico para Gana en Casa
      // Los selectores y el proceso pueden ser diferentes
  ...
  async loadChips(username, amount) {
    try {
      ...
      // Implementar el proceso específico de carga de fichas para Gana en Casa
      // Los selectores y pasos pueden ser diferentes
